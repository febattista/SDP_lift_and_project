%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% KELLEY CUTTING PLANE - v2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Get cuts from the classes
% When tailOff or no cuts, pass to the next class
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [nod_curr_obj, nod_tot_cuts, nod_time] = kelley_cutting_plane(model_folder,sol_folder, g, model_ext, At_th, b_th, X_th, blk, obj_th, theta_plus_time, OPTIONS, splitted)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% KELLEY CUTTING PLANE - v1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Get cuts from the classes
% Stop when tailOff or no cuts
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function [nod_curr_obj, nod_tot_cuts, nod_time] = kelley_cutting_plane(model_folder,sol_folder, g, model_ext, At_th, b_th, X_th, blk, obj_th, theta_plus_time, OPTIONS, splitted)
...
%     violated_classes = cut_classes(I);
%     for i=1:num_classes
%         I_i = I(violated_classes==i);
%         to_add = [to_add; I_i];
%         if (size(to_add, 1) >= max_c)
%             break
%         end
%     end
%     % ord_viol = ord_viol(idx);
